...
export default function SpeakIcon(props) {
  ...
  return (
    ...
    >
      ...
      <G transform="translate(52.54 -20.188) matrix(.28238 0 0 .2792 -37.334 -19.665) translate(119.2 -1.68) translate(-119.97 -1.046)">
        <Circle
          cx={-38.083298}
          cy={171.98366}
          r={7.3153419}
